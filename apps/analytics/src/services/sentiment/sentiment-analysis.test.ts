  ...
  describe("OnChain Sentiment with Advanced Metrics", () => {
    ...
    test("should recognize overvalued conditions with MVRV > 3.7", async () => {
      ...
      mockClickhouse.query = mock(async (query: string) => {
        ...
        if (query.includes("candles")) {
          return mockTechnicalData.concat(
            Array(199).fill(mockTechnicalData[0])
          );
        }
        return [];
      });
    ...
    test("should use dynamic thresholds with historical data", async () => {
      ...
      const historicalData = [
        ...
        {
          whale_tx_count: 18,
          exchange_net_flow: 100,
          active_addresses: 55_000,
          mvrv_ratio: 1.4,
          nupl: 0.18,
        },
        {
    ...
    test("should calculate trends from historical data", async () => {
      ...
      const historicalData = [
        ...
        },
        {
          whale_tx_count: 26,
          exchange_net_flow: -200,
          active_addresses: 72_000,
          mvrv_ratio: 1.3,
          nupl: 0.15,
        },
        {
          whale_tx_count: 27,
          exchange_net_flow: -300,
          active_addresses: 75_000,
          mvrv_ratio: 1.5,
          nupl: 0.2,
        },
        {
          whale_tx_count: 28,
          exchange_net_flow: -400,
          active_addresses: 77_000,
          mvrv_ratio: 1.6,
          nupl: 0.25,
        },
      ];
      ...
      const historicalData = [
        {
          ...
          exchange_net_flow: -100,
          active_addresses: 70_000,
          exchange_reserve: 1_100_000,
        },
        {
          whale_tx_count: 25,
          exchange_net_flow: -200,
          active_addresses: 72_000,
          exchange_reserve: 1_050_000,
        },
        {
          whale_tx_count: 25,
          exchange_net_flow: -300,
          active_addresses: 73_000,
          exchange_reserve: 1_000_000,
        },
        {
          whale_tx_count: 25,
          exchange_net_flow: -400,
          active_addresses: 74_000,
          exchange_reserve: 950_000,
        },
      ];
    ...
    test("should increase confidence with strong trends", async () => {
      ...
      const historicalData = [
        ...
        },
        {
          timestamp: new Date().toISOString(),
          whale_tx_count: 30,
          exchange_net_flow: -600,
          active_addresses: 81_000,
          mvrv_ratio: 1.6,
          nupl: 0.3,
          exchange_reserve: 940_000,
        },
        {
          timestamp: new Date().toISOString(),
          whale_tx_count: 30,
          exchange_net_flow: -700,
          active_addresses: 82_000,
          mvrv_ratio: 1.3,
          nupl: 0.15,
          exchange_reserve: 920_000,
        },
        {
          timestamp: new Date().toISOString(),
          whale_tx_count: 30,
          exchange_net_flow: -800,
          active_addresses: 83_000,
          mvrv_ratio: 1.1,
          nupl: 0.05,
          exchange_reserve: 910_000,
        },
      ];
