...
- **[GETTING_STARTED.md](docs/GETTING_STARTED.md)** - 🚀 Быстрый старт и первые шаги
- **[API_REFERENCE.md](docs/API_REFERENCE.md)** - 🔌 Полный справочник REST API и WebSocket
- **[FEATURES.md](docs/FEATURES.md)** - ✨ Все возможности платформы
- **[ARCHITECTURE.md](docs/ARCHITECTURE.md)** - 🏗️ Архитектура, порты, производительность, безопасность
- **[ROADMAP.md](docs/ROADMAP.md)** - 🎯 План развития платформы
...
1. [README.md](./README.md) - обзор проекта (вы здесь)
2. [GETTING_STARTED.md](docs/GETTING_STARTED.md) - установка и запуск
3. [FEATURES.md](docs/FEATURES.md) - что умеет платформа

**Разработчикам:**

1. [API_REFERENCE.md](docs/API_REFERENCE.md) - все эндпоинты
2. [ARCHITECTURE.md](docs/ARCHITECTURE.md) - как все устроено
3. [CHANGELOG.md](docs/CHANGELOG.md) - что изменилось

**Планирование:**

1. [ROADMAP.md](docs/ROADMAP.md) - что будет дальше
